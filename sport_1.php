            ...
            <div id="mesta" class="collapse center">
                 <div class="accordion-group"> 
                       ...
                       <div> 
                         ...
                         <!--КОНЕЦ Кнопка закрыть окно-->
                            <!--Заполнение-->
                                    <button class="btn message margin-right-normal buttomdesignated" type="submit"/>Спортивные магазины</button>
                                    <button class="btn message margin-right-normal buttomdesignated" type="submit"/>Спортивные комплексы</button>
                                    <button class="btn message margin-right-normal buttomdesignated" type="submit"/>Фитнес-центры</button>
                                    <button class="btn message margin-right-normal buttomdesignated" type="submit"/>Туристические агенства</button>
                                    <button class="btn message margin-right-normal buttomdesignated" type="submit"/>Гостиницы и отели</button>
...
<!-- Menu vertical-->
     <div>
		<ul id="ui-menu-left" itemtype="http://schema.org/ItemList" itemscope="">
			...
			<li class="" itemprop="itemListElement">
				<a id="ui-menu-left-fashion-womens" class="ui-menu-button-notification ui-menu-button ui-menu-button-fashion-womens active" href="sport_1.php">Спорт и туризм</a>
			</li>
			<li class="" itemprop="itemListElement">
