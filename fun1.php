...
<!-- Menu vertical-->
     <div>
		<ul id="ui-menu-left" itemtype="http://schema.org/ItemList" itemscope="">
			...
			<li class="" itemprop="itemListElement">
				<a id="ui-menu-left-art" class="ui-menu-button-notification ui-menu-button ui-menu-button-art active" href="fun1.php">Развлечения и отдых</a>
			</li>
			<li class="" itemprop="itemListElement">
