            ...
            <div class="navbar-inner">
                ...
                <div class="container container-width-header">
                    <a class="brand brand-left" href="index.php">
                        <em>Любимые места/</em><a class="brand" href="vhod.php">Личный кабинет</em></a>
 ...
 <!-- ОКНО НАСТРОЙКИ..ЛИЧНЫЙ КАБИНЕТ -->
					...
					<h3 id="myModalLabel">Личные данные</h3>
						...
						<div class="modal-body bs-docs-example tooltip-demo">
                            <label class="span2 labmodal">ФИО</label><input type="text" id="FIO" placeholder="Фамилия Имя" disabled="disabled"/>
							...
							<label class="span2 labmodal">mail</label><input type="text" id="mail" placeholder="name@mail.ru" disabled="disabled"/>
							...
							<label class="span2 labmodal">пароль</label><input type="password" id="password" placeholder="*********" disabled="disabled"/>
							...
							<div id="divpassword" class="span5" style="display:none;"><input class="width_input right"type="password" id="password2" placeholder="повторить пароль" disabled="disabled"/></div>
							<label class="span2 labmodal">id ВКОНТАКТЕ</label><input type="text" id="idvk" placeholder="vk.com/id123456" disabled="disabled"/>
